...
def parse_args():
    ...
    parser.add_argument('--data_name', type=str, default='CWRUPath', help='the name of the data')
    parser.add_argument('--input_type', choices=['TD', 'FD', 'other'], type=str, default='FD',help='the input type decides the length of input')
    parser.add_argument('--data_dir', type=str, default="../GNNforIFD/data/CWRU",help='the directory of the data')
    parser.add_argument('--cuda_device', type=str, default='0', help='assign device')
    parser.add_argument('--checkpoint_dir', type=str, default='E:/001 自行查阅/素材6_GNN/GNN_时序信号混合/GNNforIFD/GNNforIFD/checkpoint', help='the directory to save the model')
